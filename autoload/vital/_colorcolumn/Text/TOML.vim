...
execute join(['function! vital#_colorcolumn#Text#TOML#import() abort', printf("return map({'parse': '', 'parse_file': ''}, \"vital#_colorcolumn#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
